import type { Address, BaseToken, FastWithdrawalPermit, Hex, UserConfig } from "@arcadia-network/utils";
import { randomHex, requestAccounts, toHex } from "@arcadia-network/utils";
